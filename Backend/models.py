...
class BaseDataMapping(db.Model):
    ...
    is_one_time_input = db.Column(db.Boolean, default=False)
    is_on_going_input_rarely_updated = db.Column(db.Boolean, default=False)
    is_on_going_input = db.Column(db.Boolean, default=False)
...
class PsslBaseData(db.Model):
    ...
    spread = db.Column(db.String, nullable=True)
    dip_loan = db.Column(db.String)
    ...
    relevent_test_period = db.Column(db.Date)
...
class VaeData(db.Model):
    ...
    ttm_ebitda = db.Column(db.Numeric)
    senior_debt = db.Column(db.Numeric)
    total_debt = db.Column(db.Numeric)
    unrestricted_cash = db.Column(db.Numeric)
    net_senior_leverage = db.Column(db.Numeric)
    net_total_leverage = db.Column(db.Numeric)
    interest_coverage = db.Column(db.Numeric)
    recurring_revenue = db.Column(db.Numeric)
    debt_to_recurring_revenue_ratio = db.Column(db.Numeric)
    liquidity = db.Column(db.Numeric)
    assigned_value = db.Column(db.Numeric)
    created_by = db.Column(db.Integer)
