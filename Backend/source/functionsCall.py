import pandas as pd
import math
from source.PL_BB_Build import *
from source.Subscription_BB import *
from source.PL_BB_Results import *
from source.cash import *
from source.pl_bb_build_Availability import *
import numpy as np
...
def functions_call_calculation(
    df_PL_BB_Build,
    df_Inputs_Other_Metrics,
    df_Availability_Borrower,
    df_PL_BB_Results,
