...
from source.PFLT_Borrowing_Base.second_level_formulas_DC_DJ import (
                ...
                if (
                    ...
                    and (
                        (
                            ...
                            and row["Haircut Ineligible"] < row["Ineligibles"]
                        )
                        or (
                            row[
                                [
        ...
        loan_list_df["Defaulted Test"] = loan_list_df.apply(
            lambda row: (
                ...
                if (
                    ...
                    and (
                        row["Defaulted Collateral Loan Balance"]
                        <= row[["Discount Loan Balance", "Credit Improved Balance", "Haircut Ineligible", "Ineligibles"]].min(
                            skipna=True
                        )
                        or (
                            row[
