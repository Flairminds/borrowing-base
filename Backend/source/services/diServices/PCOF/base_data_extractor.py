    ...
    try:
        ...
        with engine.connect() as connection:
            pcof_base_data = pd.DataFrame(connection.execute(text(f'''select distinct
                ...
                --    as "Investment Par",
                --    as "Investment cost",
                --    as "Investment External Valuation",
                --    as "Investment Internal Valuation",
                ...
                --    as "Classifications Warehouse Asset Inclusion Date" -- could not map
                ...
                --    as "Leverage Revolver Commitment", -- could not map
                ...
                --    as "Leverage Attachment Point", -- could not map
                --    as "Leverage Total Capitalization", -- from PCOF III Borrrowing Base
                    ss."LTV" as "leverage_ltv_thru_pcof_iv" -- was from PCOF IV, Now taking from security stats (BU)
                --    as "Final Eligibility Override", -- could not map
                --    as "Final comment", -- could not map
                --    as "Concentration Adjustment", -- could not map
                --    as "Concentration comment", -- could not map
                --    as "Borrowing Base Other Adjustment", -- could not map
                --    as "Borrowing Base Industry Concentration", -- could not map
                --    as "Borrowing Base comment", -- could not map
                --    as "Is Eligible Issuer", -- could not map
