...
def get_loan_type_data():
    try:
        response_data = {}
        unmapped_sr = LoanTypeMappingService.get_unmapped_loan_types()
        ...
        mapped_sr = LoanTypeMappingService.get_mapped_loan_types()
        ...
        master_sr = LoanTypeMappingService.get_master_loan_types()
...
def get_lien_type_data():
    try:
        response_data = {}
        unmapped_sr = LienTypeMappingService.get_unmapped_lien_types()
        if unmapped_sr["success"] is False:
        ...
        mapped_sr = LienTypeMappingService.get_mapped_lien_types()
        if mapped_sr["success"] is False:
        ...
        master_sr = LienTypeMappingService.get_master_lien_types()
        if master_sr["success"] is False:
